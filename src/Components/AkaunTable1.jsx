        ...
        <div className='relative'>
            <div className="flex items-center gap-2 justify-end absolute w-full top-[-3.2rem] right-0">
                ...
                <div className="bg-white p-3 flex cursor-pointer items-center rounded-lg gap-2 ">
                    ...
                    <h2 className='text-[#4A4A4A] text-xs font-bold'>Filter by</h2>
                </div>
                <div className="bg-white p-3 flex cursor-pointer items-center rounded-lg gap-2 ">
                    <HiBars3BottomLeft />
                    <h2 className='text-[#4A4A4A] text-xs font-bold'>Sort by</h2>
                </div>
                <SlClose onClick={clearAllFunctionality} className='text-[#D40000] cursor-pointer text-xl' />
            </div>
